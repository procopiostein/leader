...
%10: sagital displacement (new feature)
...
% %(- rel vel x (9), stdv ld(20), stdv angle(22), stdv rel vel x(24))
%   legend('1. target velocity',...
%       '2. lateral displ.',...
%       '3. rel. heading',...
%       '4. angle',...
...
%       '9. stdv rel. head.',...
%       '10. stdv distance',...
%       '11. stdv relative vel. y',...
%       '12. stdv sagital displ.',...
%       'Location','eastOutside');
...
%       '8. sagital displ.',...
%       '9. stdv target vel.',...
%       '10. stdv lateral displ.',...
%       '11. stdv rel. head.',...
%       '12. stdv angle',...
%       '13. stdv distance',...
%       '14. stdv relative vel. x',...
%       '15. stdv relative vel. y',...
%       '16. stdv sagital displ.',...
%       'Location','eastOutside');
...
%       '8. sagital displ.',...
%       '9. \Delta target vel.',...
%       '10. \Delta lateral displ.',...
%       '11. \Delta rel. head.',...
%       '12. \Delta angle',...
%       '13. \Delta distance',...
%       '14. \Delta relative vel. x',...
%       '15. \Delta relative vel. y',...
%       '16. \Delta sagital displ.',...
%       '17. stdv target vel.',...
%       '18. stdv lateral displ.',...
%       '19. stdv rel. head.',...
%       '20. stdv angle',...
%       '21. stdv distance',...
%       '22. stdv relative vel. x',...
%       '23. stdv relative vel. y',...
%       '24. stdv sagital displ.',...
%       'Location','eastOutside');
